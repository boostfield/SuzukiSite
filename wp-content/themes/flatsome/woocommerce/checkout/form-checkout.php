...
if ( ! $checkout->enable_signup && ! $checkout->enable_guest_checkout && ! is_user_logged_in() ) {
	echo apply_filters( 'woocommerce_checkout_must_be_logged_in_message', __( 'You must be logged in to checkout.','flatsome-admin' ) );
	return;
}
  	...
  	<div class="large-5 col">
  		<div class="col-inner <?php echo $sidebar_classes; ?>">
  			<div class="checkout-sidebar sm-touch-scroll">
  				<h3 id="order_review_heading"><?php _e( 'Your order','flatsome-admin' ); ?></h3>
