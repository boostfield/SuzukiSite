...
Flatsome_Option::add_field( 'option',  array(
	'type'        => 'text',
	'settings'     => 'follow_weibo',
	'label'       => __( '新浪微博', 'flatsome-admin' ),
	'transport' => $transport,
	'section'     => 'follow',
	'default'     => '',
));
...
Flatsome_Option::add_field( 'option',  array(
	'type'        => 'text',
	'settings'     => 'follow_weixin',
	'label'       => __( '微信', 'flatsome-admin' ),
	'transport' => $transport,
	'section'     => 'follow',
	'default'     => '',
));
...
Flatsome_Option::add_field( 'option',  array(
	...
	'description' => '上传一个Snapcode图像. 您可以在这里生成: https://accounts.snapchat.com/accounts/snapcodes',
	'section'     => 'follow',
	'transport' => $transport,
));
