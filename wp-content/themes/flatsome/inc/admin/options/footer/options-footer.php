...
Flatsome_Option::add_field( '', array(
    ...
    'default'     => '<div class="options-title-divider" style="margin-bottom:15px">小工具</div><p>点击按钮转到小工具</p><div><button style="margin-bottom:15px" class="button button-primary" data-to-panel="widgets">编辑小工具</button></div>',
) );
...
Flatsome_Option::add_field( '', array(
    ...
    'label'       => __( '', 'flatsome-admin' ),
   	'active_callback' => $hide_footer_options,
	'section'     => 'footer',
    'default'     => '<div class="options-title-divider">页脚 1</div>',
) );
...
Flatsome_Option::add_field( '', array(
    ...
    'label'       => __( '', 'flatsome-admin' ),
	'section'     => 'footer',
    'default'     => '<div class="options-title-divider">页脚 2</div>',
   	'active_callback' => $hide_footer_options
) );
...
Flatsome_Option::add_field( '', array(
    ...
    'label'       => __( '', 'flatsome-admin' ),
	'section'     => 'footer',
    'default'     => '<div class="options-title-divider">绝对页脚</div>',
) );
...
Flatsome_Option::add_field( '', array(
    ...
    'label'       => __( '', 'flatsome-admin' ),
	'section'     => 'footer',
    'default'     => '<div class="options-title-divider">页脚HTML</div>',
) );
