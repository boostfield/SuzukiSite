...
Flatsome_Option::add_field( 'option',  array(
  ...
  'description' => __( 'Create a custom product layout by using the UX Builder. You need to select a Block and then open it in the UX Builder from the product page.', 'flatsome-admin' ),
  'section'     => 'product-page',
...
Flatsome_Option::add_field( '', array(
    ...
    'label'       => __( '', 'flatsome-admin' ),
	'section'     => 'product-page',
    'default'     => '<div class="options-title-divider">添加至购物车</div>',
) );
