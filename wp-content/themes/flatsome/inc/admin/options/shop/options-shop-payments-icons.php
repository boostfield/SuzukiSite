...
Flatsome_Option::add_section( 'payment-icons', array(
	...
	'description' => '注意: 这不是选择支付的方法. 这仅是显示支付图标. 您可以使用简码 [ux_payment_icons]放在任何地方',
	'panel' => 'shop'
) );
...
Flatsome_Option::add_field( 'option',  array(
	...
	'choices'     => array(
	    'alipay' => __( '支付宝', 'flatsome-admin' ),
		'weixinpay' => __( '微信支付', 'flatsome-admin' ),
		'tenpay' => __( '财付通', 'flatsome-admin' ),
