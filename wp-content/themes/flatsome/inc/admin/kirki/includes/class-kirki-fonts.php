...
if ( ! class_exists( 'Kirki_Fonts' ) ) {
	...
	final class Kirki_Fonts {
		 ...
		 */
		 public static function get_standard_fonts() {
			...
			$standard_fonts = array(
			    'lato-yahei' => array(
					'label' => $i18n['lato-yahei'],
					'stack' => 'Lato,Microsoft Yahei',
				),
				'raleway-yahei' => array(
					'label' => $i18n['raleway-yahei'],
					'stack' => 'Raleway,Microsoft Yahei',
				),
				'poppins-yahei' => array(
					'label' => $i18n['poppins-yahei'],
					'stack' => 'Poppins,Microsoft Yahei',
				),
				'montserrat-yahei' => array(
					'label' => $i18n['montserrat-yahei'],
					'stack' => 'Montserrat,Microsoft Yahei',
				),
				'josefin-slab-yahei' => array(
					'label' => $i18n['josefin-slab-yahei'],
					'stack' => 'Josefin Slab,Microsoft Yahei',
				),
				'microsoft-yahei' => array(
					'label' => $i18n['microsoft-yahei'],
		...
		public static function get_backup_fonts() {
			$backup_fonts = array(
				'lato-yahei'  => 'Lato,Microsoft Yahei',
				'raleway-yahei'  => 'Raleway,Microsoft Yahei',
				'poppins-yahei' => 'Poppins,Microsoft Yahei',
				'montserrat-yahei' => 'Montserrat,Microsoft Yahei',
				'josefin-slab-yahei' => 'Josefin Slab,Microsoft Yahei',
