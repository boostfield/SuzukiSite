...
class Flatsome_Admin {
	...
	public function flatsome_panel_register_menu() {
		...
		add_menu_page( '欢迎使用Flatsome', 'flatsome-admin', 'manage_options', 'flatsome-panel', array( $this, 'flatsome_panel_welcome' ), get_template_directory_uri().'/assets/img/logo-icon.svg', '2');
		
		add_submenu_page('flatsome-panel', '主题许可', '主题许可', 'manage_options', 'admin.php?page=flatsome-panel' );
		...
		add_submenu_page('flatsome-panel', '帮助&指导', '帮助&指导', 'manage_options', 'flatsome-panel-support', array( $this, 'flatsome_panel_support') );

		//add_submenu_page('flatsome-panel', 'Plugins', 'Plugins', 'manage_options', 'flatsome-panel-plugins', array( $this, 'flatsome_panel_plugins') );

		add_submenu_page('flatsome-panel', '修改日志', '修改日志', 'manage_options', 'flatsome-panel-changelog', array( $this, 'flatsome_panel_changelog') );

	    add_submenu_page('flatsome-panel', '', '主题选项', 'manage_options', 'customize.php' );
	}
