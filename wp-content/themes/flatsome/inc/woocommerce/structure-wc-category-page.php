...
if(is_admin()){
    ...
    function top_text_taxonomy_edit_meta_field($term) {
        ...
        if(!$term_meta){$term_meta = add_term_meta($t_id, 'cat_meta', '');}
         ?>
        <tr class="form-field">
        <th scope="row" valign="top"><label for="term_meta[cat_header]"><?php _e( 'Top Content', 'flatsome-admin' ); ?></label></th>
            <td>
                    <?php
                ...
                <p class="description"><?php _e( 'Enter a value for this field. Shortcodes are allowed. This will be displayed at top of the category.','flatsome-admin' ); ?></p>
            </td>
        </tr>
    <?php
    }
    ...
    function bottom_text_taxonomy_edit_meta_field($term) {
      ...
      if(!$term_meta){$term_meta = add_term_meta($t_id, 'cat_meta', '');}
       ?>
      <tr class="form-field">
      <th scope="row" valign="top"><label for="term_meta[cat_footer]"><?php _e( 'Bottom Content', 'flatsome-admin' ); ?></label></th>
        <td>
            <?php
          ...
          <p class="description"><?php _e( 'Enter a value for this field. Shortcodes are allowed. This will be displayed at bottom of the category.','flatsome-admin' ); ?></p>
        </td>
      </tr>
    <?php
    }
