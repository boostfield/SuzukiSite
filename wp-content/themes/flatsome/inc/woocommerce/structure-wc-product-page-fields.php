...
if(!function_exists('wc_custom_product_data_fields')){
  ...
  function wc_custom_product_data_fields(){
    ...
    $custom_product_data_fields[] = array(
          'tab_name'    => __('Extra', 'flatsome-admin'),
    );
    ...
    $custom_product_data_fields[] = array(
          ...
          'description' => __('Enable a custom bubble on this product.', 'flatsome-admin'),
          'desc_tip'    => true,
           'options'     => array(
              ''  => 'Disabled',
              '"yes"'  => 'Enabled',
    ...
    $custom_product_data_fields[] = array(
          'id'          => '_custom_tab',
          'type'        => 'textarea',
          'label'       => __('Custom Tab Content', 'flatsome-admin'),
          //'placeholder' => __('', 'flatsome-admin'),
          'style'       => 'width:100%;height:140px;',
          'description' => __('Enter content for custom product tab here. Shortcodes are allowed', 'flatsome-admin'),
          //'desc_tip'    => true,
    );
   ...
   $custom_product_data_fields[] = array(
          ...
          'label'       => __('Product Video', 'flatsome-admin'),
          'style'       => 'width:100%;',
          'description' => __('Enter a Youtube or Vimeo Url of the product video here. We recommend uploading your video to Youtube.', 'flatsome-admin'),
          //'desc_tip'    => true,
    );
    ...
    $custom_product_data_fields[] = array(
          ...
          'description' => __('Select where you want to display product video.', 'flatsome-admin'),
          'desc_tip'    => true,
           'options'     => array(
              ''  => 'Lightbox (Default)',
              'tab'  => 'New Tab'
    ...
    $custom_product_data_fields[] = array(
          'id'          => '_top_content',
          'type'        => 'textarea',
          'label'       => __('Top Content', 'flatsome-admin'),
          //'placeholder' => __('', 'wc_cpdf'),
          'style'       => 'width:100%;height:140px;',
          'description' => __('Enter content that will show after the header and before the product. Shortcodes are allowed', 'flatsome-admin'),
          //'desc_tip'    => true,
    );
    ...
    $custom_product_data_fields[] = array(
          'id'          => '_bottom_content',
          'type'        => 'textarea',
          'label'       => __('Bottom Content', 'flatsome-admin'),
          //'placeholder' => __('', 'wc_cpdf'),
          'style'       => 'width:100%;height:140px;',
          'description' => __('Enter content that will show after the product info. Shortcodes are allowed', 'flatsome-admin'),
          //'desc_tip'    => true,
    );
