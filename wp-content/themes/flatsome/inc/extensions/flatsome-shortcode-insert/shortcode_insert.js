                        ...
                        },
			{
                        ...
                        },
                        {
                            ...
                            menu: [
                             {
                                    text: '关注图标',
                                    value: '[follow weibo="http://" tqq="http://" weixin="http://" qq="http://" twitter="http://" facebook="http://" email="email@post.com" pinterest="http://" rss="http://" instagram="http://" googleplus="http://"]',
                                    onclick: function(e) {
                                        e.stopPropagation();
                                        editor.insertContent(this.value());
                                    }       
                                ...
                                {
                                    text: '关注图标 - 小',
                                    value: '[follow size="small" weibo="http://" tqq="http://" weixin="http://" qq="http://" twitter="http://" facebook="http://" email="email@post.com" pinterest="http://" rss="http://" instagram="http://" googleplus="http://"]',
                                    onclick: function(e) {
                                        e.stopPropagation();
                                        editor.insertContent(this.value());
                                    }       
...
function ux_add_uxbanner(editor){
    ...
    editor.windowManager.open( {
        ...
        },
        {
            ...
            label: '背景视差', 
            'values': [
                {text: '关闭', value:'parallax="0"'},
                {text: '低', value: 'parallax="1"'},
                {text: '普通', value: 'parallax="3"'},
                {text: '较强', value: 'parallax="6"'},
                {text: '最强', value: 'parallax="9"'},
            ]
        },
        ...
        },
        {
            ...
            label: '效果', 
            'values': [
                {text: '无效果', value: 'effect=""'},
                {text: '雪', value: 'effect="snow"'},
                {text: '五彩纸屑', value: 'effect="confetti"'},
                {text: '滑动玻璃', value: 'effect="sliding-glass"'},
                {text: '光亮', value: 'effect="sparkle"'},
                {text: '雨', value: 'effect="rain"'},
            ]
        },
    ],
        onsubmit: function( e ) {
...
function ux_add_section(editor){
    ...
    editor.windowManager.open( {
        ...
        },
        {
            ...
            'values': [
                {text: '正常', value: ''},
                {text: '浅色 (对于深色背景)', value: 'dark="true"'},
            ]
        }
...
function ux_add_row(editor){
    editor.windowManager.open( {
        ...
        },
        {
            ...
            'values': [
                {text: '无效果', value:' '},
                {text: '着重', value: 'hover="focus"'},
                {text: '淡入', value:'hover="fade"'},
                {text: '模糊', value: 'hover="blur"'},
                {text: '灰度缩放', value: 'hover="grayscale"'},
            ]
        },
        {
            type: 'listbox', 
            ...
            'values': [
                {text: '默认', value:' '},
                {text: '塌陷 (无内边距)', value: 'style="collapse"'},
                {text: '带线分隔符', value:'style="divided"'},
                {text: '盒子风格', value:'style="boxed"'},
            ]
        },
         {
            type: 'listbox', 
            ...
            label: '栏内容', 
            'values': [
                {text: '空白', value:'Insert content here...<br>'},
                {text: '文本', value:'<h3>Add a title here</h3>[divider]<p>Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.</p>'},
                {text: '特色盒 - 图标顶部', value:'[featured_box title="Title text" img="http://iconurl" img_width="" pos="center" link=""]<p>Featured box text</p>[/featured_box]<br>'},
                {text: '特色盒 - 图标左边', value:'[featured_box title="Title text" img="http://iconurl" img_width="" pos="left" link=""]<p>Featured box text</p>[/featured_box]<br>'},
                {text: '团队成员', value:'[team_member name="Name" title="Title" facebook="http://" twitter="http://" pinterest="http://"  img="http://imageurl"]<br>Team member description<br>[/team_member]<br>'},
                {text: '价格表', value:'[ux_price_table title="Awesome title" featured="false" description="This is a description" button_text="Order Now" button_link="#"]<br>[bullet_item text="This is a bullet item"]<br>[bullet_item text="This is a bullet item"]<br>[bullet_item text="This is a bullet item"]<br>[/ux_price_table]<br>'},
                {text: '见证', value:'[testimonial image="http://imageurl" name="Author name" company="Company name" stars="5"]<br> Add testemonial text here <br>[/testimonial]<br>'},
            ]
        }
...
function ux_add_bmap(editor){
    ...
    editor.windowManager.open( {
        ...
        },
		{
            ...
            name: 'address', 
            label: '说明',
            value: '地址：北京市海淀区上地十街10号<br/>电话：(010)59928888<br/>简介：百度大厦位于北京市海淀区西二旗地铁站附近，为百度公司综合研发及办公总',
        },
        {
            type: 'button', 
            name: 'button', 
        ...
        onsubmit: function( e ) {
            editor.insertContent( '[bmap bkey="'+e.data.bkey+'" image="'+ux_selected_image+'" long="'+e.data.long+'" lat="'+e.data.lat+'" height="'+e.data.height+'" zoom="'+e.data.zoom+'" title="'+e.data.title+'" address="'+e.data.address+'"]');
        }
    });
}
...
var uxAnimations = [
    {text: '无动画', value:''},
    {text: '左边淡入', value:'animate="fadeInLeft"'},
    {text: '右边淡入', value: 'animate="fadeInRight"'},
    {text: '上边淡入', value: 'animate="fadeInUp"'},
    {text: '下边淡入', value: 'animate="fadeInDown"'},
    {text: '跳入', value: 'animate="bounceIn"'},
    {text: '上跳入', value: 'animate="bounceInUp"'},
    {text: '下跳入', value: 'animate="bounceInDown"'},
    {text: '左跳入', value: 'animate="bounceInLeft"'},
    {text: '右跳入', value: 'animate="bounceInRight"'},
    {text: '左转入', value: 'animate="rotateInUpLeft"'},
    {text: '右转入', value: 'animate="rotateInDownRight"'},
    {text: '水平翻入', value: 'animate="flipInX"'},
    {text: '垂直翻入', value: 'animate="flipInY"'},
]
