...
add_ux_builder_shortcode( 'ux_banner', array(
  ...
  'presets' => array(
    ...
    array(
      'name' => __( 'Buttons Left' , 'flatsome-admin'),
    ...
    array(
      'name' => __( 'Buttons Right', 'flatsome-admin' ),
    ...
    array(
      'name' => __( 'Left Light', 'flatsome-admin' ),
    ...
    array(
      'name' => __( 'Right Light', 'flatsome-admin' ),
    ...
    array(
     ...
     array(
      'name' => __( 'Dark Box Left' , 'flatsome-admin'),
     ...
     array(
      'name' => __( 'Circle Right' , 'flatsome-admin'),
     ...
     array(
      'name' => __( 'Huge Sale' , 'flatsome-admin'),
    ...
    array(
      'name' => __( 'Badge Bubble' , 'flatsome-admin'),
    ...
    array(
      'name' => __( 'Badge Simple' , 'flatsome-admin'),
