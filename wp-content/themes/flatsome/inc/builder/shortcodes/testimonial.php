...
add_ux_builder_shortcode( 'testimonial', array(
    'type' => 'container',
    'name' => __( 'Testimonial',  'flatsome-admin'),
    ...
    'presets' => array(
        ...
        array(
          'name' => __( 'Row - Image Left' , 'flatsome-admin'),
         ...
         array(
          'name' => __( 'Row - Image On Top',  'flatsome-admin'),
        ...
        array(
          'name' => __( 'Row - Boxed',  'flatsome-admin'),
         ...
         array(
          'name' => __( 'In a slider' , 'flatsome-admin'),
    ...
    'options' => array(
       ...
       'name' => array(
        ...
        'stars' => array(
               'type' => 'slider',
               'heading' => __( 'Stars', 'flatsome-admin'),
               'default' => 5,
               'max' => 5,
               'min' => 0,
        ),
