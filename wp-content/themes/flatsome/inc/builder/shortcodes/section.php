...
add_ux_builder_shortcode( 'section', array(
    'type' => 'container',
    'name' => __( 'Section', 'flatsome-admin'),
    ...
    'presets' => array(
        ...
        array(
            'name' => __('Simple Center', 'flatsome-admin'),
            'thumbnail' =>  flatsome_ux_builder_thumbnail( 'sections/simple-center' ),
         ...
         array(
            'name' => __('Arrow Top', 'flatsome-admin'),
         ...
         array(
            'name' => __('Box Right Dark', 'flatsome-admin'),
        ...
        array(
            'name' => __('Box Left Dark', 'flatsome-admin'),
         ...
         array(
            'name' => __('Box Right', 'flatsome-admin'),
        ...
        array(
            'name' => __('Box Left', 'flatsome-admin'),
        ...
        array(
            'name' => __('Media Left Large', 'flatsome-admin'),
        ...
        array(
            'name' => __('Media Right Large', 'flatsome-admin'),
            'thumbnail' =>  flatsome_ux_builder_thumbnail( 'sections/media-right-large' ),
        ...
        array(
            'name' => __('Media Right Large Dark', 'flatsome-admin'),
        ...
        array(
            'name' => __('Media Left Large Dark', 'flatsome-admin'),
        ...
        array(
            'name' => __('Media Center', 'flatsome-admin'),
        ...
        array(
            'name' => __('Media Top', 'flatsome-admin'),
        ...
        array(
            'name' => __('Media Bottom', 'flatsome-admin'),
