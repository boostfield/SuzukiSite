...
function flatsome_setup() {
  ...
  register_nav_menus( array(
    'primary' => __( 'Main Menu', 'flatsome-admin' ),
    'primary_mobile' => __( 'Main Menu - Mobile', 'flatsome-admin' ),
    'footer' => __( 'Footer Menu', 'flatsome-admin' ),
    'top_bar_nav' => __( 'Top Bar Menu', 'flatsome-admin' ),
    'my_account' => __( 'My Account Menu', 'flatsome-admin' ),
  ) );
...
function flatsome_widgets_init() {
  ...
  register_sidebar( array(
    'name'          => __( 'Sidebar', 'flatsome-admin' ),
    'id'            => 'sidebar-main',
   ...
   register_sidebar( array(
    'name'          => __( 'Footer 1', 'flatsome-admin' ),
    'id'            => 'sidebar-footer-1',
   ...
   register_sidebar( array(
    'name'          => __( 'Footer 2', 'flatsome-admin' ),
    'id'            => 'sidebar-footer-2',
    'before_widget' => '<div id="%1$s" class="col pb-0 widget %2$s">',
    'after_widget'  => '</div>',
    'before_title'  => '<span class="widget-title">',
