...
.label-new.menu-item > a:after{content:"<?php _e('New','flatsome-admin'); ?>";}
.label-hot.menu-item > a:after{content:"<?php _e('Hot','flatsome-admin'); ?>";}
.label-sale.menu-item > a:after{content:"<?php _e('Sale','flatsome-admin'); ?>";}
.label-popular.menu-item > a:after{content:"<?php _e('Popular','flatsome-admin'); ?>";}
