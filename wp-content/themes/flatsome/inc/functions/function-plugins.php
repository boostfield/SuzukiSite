...
function flatsome_register_required_plugins() {
    ...
    $config = array(
        ...
        'strings'      => array(
            ...
            'installing'                      => __( 'Installing Plugin: %s', 'flatsome-admin'), // %s = plugin name.
            ...
            'complete'                        => __( 'All plugins installed and activated successfully. %s', 'flatsome-admin'), // %s = dashboard link.
